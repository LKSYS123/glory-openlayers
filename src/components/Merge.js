...
const Merge = () => {
    useEffect(() => {
        ...
        */
        ...
        class Draws {
            ...
            onDrawEnd = (e) => {
                if (this.vector_layer.getSource().getFeatures().length <= 1) {
                    ...
                    alert(
                        'Only two features are allowed to merge. At present, merge functionality only supports merging of two adjacent features.'
                    );
        ...
        let map = new OLMap('map', 9, [-96.6345990807462, 32.81890764151014])
            .map;
        ...
        let mergePolygon = (e) => {
            ...
            */
            ...
            let a = parser.read(
                vector_layer.getSource().getFeatures()[0].getGeometry()
            );
            let b = parser.read(
                vector_layer.getSource().getFeatures()[1].getGeometry()
            );
