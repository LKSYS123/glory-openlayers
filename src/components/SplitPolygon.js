            ...
            for (let q = 0; q < clipped.geometry.coordinates.length; q++) {
                if (clipped.geometry.coordinates[q][0].length === 5) {
                    const cutCoordinate = get_DragBoxCoordToScreenOrder(
                        clipped.geometry.coordinates[q],
                        map
                    );
                    clippedList.push(
                        cutCoordinate.getGeometry().getCoordinates()
                    );
                }
            }

            // ==================== 드래그 방향에 따른 Polygon 순서

            if (dragDirection === 'DownRight') {
                // ======== 드래그 아래 오른쪽
                for (let i = 0; i < clippedList.length - 1; i++) {
            ...
            [
                {
                    coordinates: [
                        [
                            upperList[0].flatCoordinates[0],
                            upperList[0].flatCoordinates[1],
                        ],
                        [
                            lowList[0].flatCoordinates[0],
                            lowList[0].flatCoordinates[1],
                        ],
                    ],
                    type: 'LineString',
                },
            ...
            [
                {
                    coordinates: [
                        [
                            leftList[0].flatCoordinates[0],
                            leftList[0].flatCoordinates[1],
                        ],
                        [
                            rightList[0].flatCoordinates[0],
                            rightList[0].flatCoordinates[1],
                        ],
                    ],
                    type: 'LineString',
                },
